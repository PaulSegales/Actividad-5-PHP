        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container mt-5">
                    <form action="update_estudiante.php" method="POST">
                    
                    <input type="hidden" name="codigo" value="<?php echo $row['codigo']  ?>">
                                
                    <input type="text" class="form-control mb-3" name="nom_std" placeholder="Dni" value="<?php echo $row['nom_std']  ?>">
                    <input type="text" class="form-control mb-3" name="carrera" placeholder="Nombres" value="<?php echo $row['carrera']  ?>">
